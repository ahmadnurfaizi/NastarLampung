				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+62) 858 0965 0585" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+62) 858 0965 0585</a>
								</li>
							</ul>
						</div>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset('assets/images/Logo.JPG') }}" alt="logo"></a>
						</div>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/about" class="link-term mercado-item-title">About</a>
								</li>
								<li class="menu-item">
					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Kemiling dan Sekitarnya</p>
							</div>
						</li>
						<li class="fc-info-item">
							<i class="fa fa-recycle" aria-hidden="true"></i>
							<div class="wrap-left-info">
								<h4 class="fc-name">Rasa</h4>
								<p class="fc-desc">Dijamin Nagih</p>
							</div>
						</li>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">COD DANA Transfer</p>
							</div>
						</li>
						<li class="fc-info-item">
							<i class="fa fa-life-ring" aria-hidden="true"></i>
							<div class="wrap-left-info">
								<h4 class="fc-name">Fresh</h4>
								<p class="fc-desc">Selalu Fresh</p>
							</div>
						</li>
					</ul>
				</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Kemiling<br>Bandar Lampung</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">085809650585</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">ahmad_nur_faizi@teknokrat.ac.id</p>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+62) 858 0965 0585</b>
									</div>
								</div>
							</div>
								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											...
											<li><a href="https://web.facebook.com" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 Ahmad Nur Faizi</p>
					</div>
					<div class="coppy-right-item item-right">
						<div class="wrap-nav horizontal-nav">
							<ul>
								<li class="menu-item"><a href="/about" class="link-term">About</a></li>
