					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Free On Oder Over Rp.99</p>
							</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Tanjung Karang Pusat<br>Bandar Lampung</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+62) 858 0965 0585</p>
											</li>
											<li>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2020 Ahmad Nur Faizi</p>
					</div>
