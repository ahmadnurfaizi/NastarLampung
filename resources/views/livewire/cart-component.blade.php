    ...
    <div class=" main-content-area">
        ...
        <div class="summary">
            <div class="order-summary">
                <h4 class="title-box">Order</h4>
                <p class="summary-info"><span class="title">Subtotal</span><b class="index">Rp.{{Cart::subtotal()}}</b></p>
                <p class="summary-info"><span class="title">Satuan</span><b class="index">Rp.{{Cart::tax()}}</b></p>
                <p class="summary-info"><span class="title">Pengiriman</span><b class="index">Gratis Ongkir</b></p>
            ...
            <div class="checkout-info">
                ...
                <a class="link-to-shop" href="/shop">Lanjut Berbelanja<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
            </div>
            <div class="update-clear">
                <a class="btn btn-clear" href="#" wire:click.prevent="destroyAll()" >Bersihkan Cart</a>
